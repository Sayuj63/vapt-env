...
<h2>Quick links</h2>
<ul>
  <li><a href="https://youtu.be/_w3uMlr_FCs?si=LqcuZZ3TZf9wID5k">🎬 <strong>90-sec founders intro</strong> (YouTube)</a> — the reasoning gap, multi-agent primitive, and 6.4× lift in 90 seconds</li>
