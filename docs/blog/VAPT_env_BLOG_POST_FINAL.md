# VAPT env: Teaching AI to Reason About Security
...
## Introducing VAPT env: SecurityAuditEnv
...
![Reward per Episode](https://huggingface.co/spaces/security-audit-env/file=plots/reward_per_episode.png)

*Red dashed: Random baseline (0.22 avg). Blue: Pre-training (0.38 avg). Green: Post-training GRPO (0.58 avg).*

### Training Loss Convergence

![Training Loss](https://huggingface.co/spaces/security-audit-env/file=plots/training_loss.png)

*Loss decreases from 1.99 to 0.11 (94.2% reduction) over 150 training steps.*

### Performance Comparison

![Performance Comparison](https://huggingface.co/spaces/security-audit-env/file=plots/performance_comparison.png)
...
### Live Environment
https://huggingface.co/spaces/security-audit-env

### Training Notebook
[VAPT_env_RL_Training_Colab.ipynb](https://github.com/security_audit_env/blob/main/VAPT_env_RL_Training_Colab.ipynb)

### GitHub Repository
https://github.com/security_audit_env
...
env = EnvClient(base_url="https://security-audit-env.hf.space")
...
**Try VAPT env today**: https://huggingface.co/spaces/security-audit-env
